...
export const guest = (() => {
    ...
    const showGuestName = () => {
        ...
        if (name) {
            ...
            const template = `<p class="mt-0 mb-1 mx-0 p-0">${util.escapeHtml(guestName?.getAttribute('data-message'))}</p><h3 class="m-0 p-0" style="font-size: 1.5rem">${util.escapeHtml(name)}</h3>`;
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = new URLSearchParams({
            action: 'TEMPLATE',
            text: 'The Wedding of Irfan & Mifta',
            dates: `${formatDate('2025-10-10 09:00')}/${formatDate('2025-10-10 10:00')}`,
            details: 'Tanpa mengurangi rasa hormat, kami mengundang Anda untuk berkenan menghadiri acara pernikahan kami. Terima kasih atas perhatian dan doa restu Anda, yang menjadi kebahagiaan serta kehormatan besar bagi kami. \n \nAlamat :\nDsn. Kembangan, Ds. Mojojajar, Kec. Kemlagi, Kab. Mojokerto, Jawa Timur \nhttps://maps.app.goo.gl/FPyRYyefipBij26K8',
            location: '-7.432018922640771, 112.35787791584586',
            ctz: config.get('tz'),
        });
